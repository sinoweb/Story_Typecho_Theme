 ...
 * @license GNU General Public License 2.0
 */
class Story_Textarea extends Typecho_Widget_Helper_Form_Element
{
    ...
    public function __construct($name = NULL, array $options = NULL, $value = NULL, $label = NULL, $description = NULL)
    {
		...
		<ul style="padding-left: 0px; list-style: none!important" id="typecho-option-item-'.$name.'-'.self::$uniqueId.'">'));
    ...
    {
        $this->addItem(new Story_CustomLabel('<div class="mdui-textfield">'));
